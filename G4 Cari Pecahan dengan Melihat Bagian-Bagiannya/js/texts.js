...
// ==================================================================
const CURRENT_LANGUAGE = "id"; // Can be changed to "id" to use Indonesian
// ==================================================================
  ...
  id: {
    appTexts: {
      ...
      instructions: {
        step_0_intro: {
          title: "Halo!",
          text: "Kalian bisa menggunakan gunting untuk membagi satu kertas jadi dua bagian. Tapi, apa yang terjadi kalau kita menggunting lagi?<br><br>Waktunya belajar semua tentang pecahan!",
        },
        step_1_setup: {
        ...
        step_3_color: {
          ...
          text: "Ayo tambahkan warna! Pilih warna dan klik pada bagian yang baru saja kalian potong.",
        },
        step_4_mcq_how_many: {
          title: "Luar Biasa!",
          text: (params) => `Kalian hebat sekali! Sekarang, bisakah kalian beri tahu aku, berapa banyak bagian yang <b style="color:${params.paperStroke};">sama besar</b> yang membentuk keseluruhan?`,
          options: [
            { display: "3", value: "3" },
            { display: "4", value: "4" },
            { display: "5", value: "5" }
